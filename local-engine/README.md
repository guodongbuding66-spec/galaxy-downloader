...
网站可以检测本地引擎是否在线，并同步引擎版本、当前状态、下载进度、下载速度、ETA、已下载大小、等待队列、可恢复任务，以及暂停、继续、放弃恢复、取消任务和打开下载文件夹等控制。
