...
function shouldRetryVimeoControlError(error: unknown): boolean {
  ...
  // Fetch network failures and AbortSignal timeout errors are transient by default.
  // Programming errors should not normally originate inside the fetch operation.
